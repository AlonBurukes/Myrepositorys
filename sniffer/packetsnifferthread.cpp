...
PacketSnifferThread::PacketSnifferThread(QStandardItemModel *packetModel, QString filePath, QStatusBar *statusBar){
    ...
    protocolColors.insert("FTP", QColor(255, 125, 125));      //Light Red
    protocolColors.insert("TELNET", QColor(183, 247, 119));      //Light Green
