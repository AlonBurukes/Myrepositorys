...
@WebServlet( "/parcle/FindDistrById")
public class FindDistrById extends HttpServlet {
    //找dao要数据
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //postman
        ParDistrInfo parDis= new ParDistrInfo();
        String parId = request.getParameter("parId");
        try {
            parDis= parclerdao.finDistrById(parId);
        } catch (Exception e) {
            e.printStackTrace();
            //System.out.println("异常");
        }

        String jsonStr = JSON.toJSONString(parDis);
